...
echo ""
echo "  The hosted attribute mapping store starts EMPTY, so no color/material fields are"
echo "  indexed until the taxonomy is seeded once (see #71). Either add --seed-taxonomy to"
echo "  the command above, or run the 'Re-Index OpenSearch' GitHub workflow with"
echo "  seed_taxonomy=true. (Destructive: rediscovers from scratch, drops agent-learned mappings.)"
echo ""
echo "============================================================"
