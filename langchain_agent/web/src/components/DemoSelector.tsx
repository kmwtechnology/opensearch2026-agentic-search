...
export function DemoSelector({ demoId, onSelect }: Props) {
  ...
  return (
    <div className="relative flex h-[66px] items-center gap-3.5 rounded-2xl border-2 border-[var(--color-stage-border)] bg-[var(--color-stage-raised)] px-5 focus-within:ring-4 focus-within:ring-[#1E40AF]/40">
